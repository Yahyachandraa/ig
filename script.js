...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Haii kalian semua", "Aku ada sesuatu nih buat kalian!", "question").then(function () {
    Swal.fire("Udah nurut aja kalian ya!").then(function () {
      Swal.fire("Jangan banyak protes!!!", "", "error").then(function () {

        const {
          value: name
        } = Swal.fire({
          title: 'Masukin nama kamu dulu,inget! Jangan sama perasaanya ya!!!',
          input: 'text',
          inputLabel: '',
                ...
                Swal.fire({
                  ...
                  Swal.fire(`Oke satu step lagi ya`).then(function () {
                    Swal.fire({
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhu iya makasiii :((`).then(function () {
                          Swal.fire('Terakhir deh nih').then(function () {
                            Swal.fire('Coba klik ikon hati di paling bawah dong')
                          })
                        })
                      } else if (result.isDenied) {
                        Swal.fire('Jahat banget emang kamu ih', '', 'error').then(function () {
